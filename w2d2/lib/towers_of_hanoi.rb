...
class TowersOfHanoi
  ...
  def play
    until won?
      puts "Which tower do you want to move the disk from?"
      from_tower = gets.chomp.to_i
      puts "Which tower do you want to put the disk on?"
  ...
  def valid_move?(from_tower, to_tower)
    return true unless @towers[from_tower].count == 0 || (@towers[to_tower].count > 0 && @towers[from_tower].last > @towers[to_tower].last)
  end
